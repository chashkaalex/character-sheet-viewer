...
describe('Comprehensive Unarmed Damage Scaling', () => {
    ...
    const testCases = [
        ...
        {
            name: 'Non-Monk with Superior Unarmed Strike (Level 5)',
            lines: [
                'Mock Fighter',
                'Human Fighter 5',
                'Hp 45 Speed 30',
        ...
        {
            name: 'Non-Monk with SUS and INA (Level 5)',
            lines: [
                'Mock Fighter',
                'Human Fighter 5',
                'Hp 45 Speed 30',
        ...
        {
            name: 'Non-Monk with SUS and INA (Level 20)',
            lines: [
                'Mock Fighter',
                'Human Fighter 20',
                'Hp 45 Speed 30',
        ...
        {
            name: 'Max Level Monk 20 with SUS and INA',
            lines: [
                'Mock Monk',
                'Human Monk 20',
                'Hp 45 Speed 30',
